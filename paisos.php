                ...
                <table class="table table-bordered" id="dt" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th>Nom</th>
                      <th>Continent</th>
                      <th class="none">Continent Id</th>
                    </tr>
                  </thead>
                  <tbody>
                        <?php 
                        $query_rsGrups = "SELECT p.id as id, p.nom as nom, c.nom as continent , c.id as continent_id
                                          FROM paisos p, continents c
                                          WHERE p.continents_id=c.id
                                          ORDER BY nom ASC";
