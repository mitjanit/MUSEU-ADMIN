...
$sql ="UPDATE persones SET nom_esportiu =  '".$nome."', nom = '".$nom."', ap1 = '".$ap1."', ap2 = '".$ap2."', croniques = '".$croniques."', fotos = '".$fotos."', entrevistes = '".$entrevistes."', data_naixament =  '".$neix."', mort = '".$mort."', mort_detall = '".$detallsmort."', detalls = '".$detalls."', material =  '".$material."', ficha = '".$ficha."', dada1 = '".$dada1."', dada2 = '".$dada2."', dada3 = '".$dada3."', detalls2 = '".$detalls2."', dni = '".$dni."', poblacions_id='".$poble."', provincia_id='".$provincia."', paisos_id='".$pais."' WHERE id='".$id."'";
//echo $sql."<br/>";
