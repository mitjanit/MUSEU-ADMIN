...
$sql ="INSERT INTO document_persona (id_persona, temporada, document, continguts, premsa, altres, fitxa, foto, entrevista, reportatge, altre1, altre2, altre3, detalls, fitxad, fotod, entrevistad, reportatged, altre1d, altre2d, altre3d) VALUES ('".$id."', '".$temporada."', '".$document."', '".$continguts."', '".$premsa."', '".$altres."', '".$fitxa."', '".$fotos."', '".$entrevista."', '".$reportatge."', '".$altre1."', '".$altre2."', '".$altre3."', '".$detalls."', '".$detallsfitxa."', '".$detallsfotos."', '".$detallsentrevista."', '".$detallsreportatge."', '".$detallsaltre1."', '".$detallsaltre2."', '".$detallsaltre3."')";
echo $sql."<br/>";
