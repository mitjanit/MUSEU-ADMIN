...
$sql ="INSERT INTO activitats_entitat (id_entitat, temporada, tipus_act, actuacions, detalls1, detalls2, fotos, entrevistes, croniques, cartell, programa, video, altre1, altre2, fotod, entrevistad, cronicad, cartelld, programad, videod, altre1d, altre2d) VALUES ('".$id."', '".$temporada."', '".$tipus."', '".$actuacio."', '".$detalls1."', '".$detalls2."', '".$fotos."', '".$entrevista."', '".$reportatge."', '".$cartell."', '".$programa."', '".$video."', '".$altre1."', '".$altre2."', '".$detallsfotos."', '".$detallsentrevista."', '".$detallsreportatge."', '".$detallscartell."', '".$detallsprograma."', '".$detallsvideo."', '".$detallsaltre1."', '".$detallsaltre2."')";
echo $sql."<br/>";
