                            ...
                            <div class="row mb-4">
                                ...
                                <div class=" col-md-2">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="text" maxlength="7" class="form-control" name="temporada" id="temporadae" required />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-2">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" id="ccartelle" name="ccartell" maxlength="12" />
                                                </div>
                                          </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class=" col-md-2">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" id="cvideoe" name="cvideo" maxlength="12" />
                                                </div>
                                          </div>
