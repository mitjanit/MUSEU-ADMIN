        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content newModal">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i> Edita Població</h5>
                  <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                  </button>
                </div>
                <form role="form" name="modalFormEdit" id="modalFormEdit" class="edita-validation" novalidate action="db/editaPoblacio.php" method="get">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class=" col-md-4">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <select class="form-control" id="e2" name="provincia" required>
                                          <option value=""></option>
                                          <?php
