<!-- dialeg modal NEW -->
<div  class="modal fade" id="myNewModalRelatEntrenador" tabindex="-1" role="dialog" aria-labelledby="myNewModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
            <div class="modal-content newModal">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-plus-square"></i> Alta Relat Entrenador</h5>
                ...
                <form role="form" name="modalFormNew" id="modalFormNew" class="new-relatentrenador-validation" novalidate action="altaRelat.php" method="get">
                  ...
                  <div id="newBody" class="modal-body">
                      <div class="row mb-4">
                          ...
                          <div class=" col-md-6">
                            <label for="jugador">Entrenador:</label>
                              <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                      <i class="fa fa-info-circle"></i>
  ...
  // Example starter JavaScript for disabling form submissions if there are invalid fields
      (function() {
        ...
        window.addEventListener('load', function() {
          ...
          var forms = document.getElementsByClassName('new-relatentrenador-validation');
