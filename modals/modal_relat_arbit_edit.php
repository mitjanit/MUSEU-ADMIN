...
<div  class="modal fade" id="myEditModalRelatJugador" tabindex="-1" role="dialog" aria-labelledby="myNewModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
            <div class="modal-content newModal">
                ...
                <form role="form" name="modalFormNew" id="modalFormNew" class="edit-relatarbit-validation" novalidate action="altaRelat.php" method="get">
  ...
  // Example starter JavaScript for disabling form submissions if there are invalid fields
      (function() {
        ...
        window.addEventListener('load', function() {
          ...
          var forms = document.getElementsByClassName('edit-relatarbit-validation');
