    ...
    <div  class="modal fade" id="myNewModal" tabindex="-1" role="dialog" aria-labelledby="myNewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content newModal">
                ...
                <form role="form" name="modalFormNew" id="modalFormNew" class="new-comps-validation" novalidate action="db/altaCompeticio.php" method="get">
    ...
    <script>
      ...
      (function() {
        ...
        window.addEventListener('load', function() {
          ...
          var forms = document.getElementsByClassName('new-comps-validation');
