...
-- Tiempo de generación: 26-07-2019 a las 10:55:25
...
(7, 'UD.Mahón', 6, 1, 51, 1922, 'Sant Carles', 'UNIÓ', 0, 0, 0, 0, 0, 0, 0, '', ''),
...
(11, 'Atco. Villacarlos', 7, 1, 51, 1965, 'Municipal - Es Castell', 'VILLACARLOS', 0, 0, 0, 0, 0, 0, 0, '', ''),
...
(5, 'PACO PEREA', 'FRANCISCO', 'PEREA', 'VILLA', NULL, 0, 1, 0, 1954, 0000, '', 'Admnin', 'Foto 10001 / Temp. 2017/18  / ', 0, '', '', '', '', '', 9, 55, 0);
